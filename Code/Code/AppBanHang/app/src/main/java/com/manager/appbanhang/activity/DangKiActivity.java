...
public class DangKiActivity extends AppCompatActivity {
    EditText email,username, pass, repass, mobile,address;
    ...
    private void dangKi() {
        ...
        if (TextUtils.isEmpty(str_email)) {
            ...
            Toast.makeText(getApplicationContext(), "Bạn chưa nhập Mobile Hoac Sai Dinh Dang", Toast.LENGTH_LONG).show();
            ...
            if (str_pass.equals(str_repass)){
                //post data
                compositeDisposable.add(apiBanHang.dangki(str_email,str_pass,str_user,str_mobile,str_address)
