...
public class ListSanPham extends BaseAdapter {
    List<LoaiSp> array;
    Context context;

    public ListSanPham(Context context, List<LoaiSp> array) {
        this.array = array;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null){
            ...
            view = layoutInflater.inflate(R.layout.customcategory, null);
            viewHolder.id = view.findViewById(R.id.id);
            viewHolder.textensp = view.findViewById(R.id.name);
